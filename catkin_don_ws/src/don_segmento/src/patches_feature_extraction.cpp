...
typedef pcl::PointXYZRGBL PointTypeIO;
// typedef pcl::PointXYZRGBA PointTypeIORGBA;
typedef pcl::PointXYZINormal PointTypeFull;
// typedef pcl::PointXYZRGBNormal PointTypeFullCustom;

bool clusterCondition(const PointTypeFull &point_a, const PointTypeFull &point_b, float /*squared_distance*/)
{
...
int main()
{
    ...
    cec.setConditionFunction(&clusterCondition);
